...
namespace Server.MirObjects.Monsters
{
    class HellKeeper : MonsterObject
    {
        ...
        protected internal HellKeeper(MonsterInfo info)
            : base(info)
        {
        ...
        protected override void Attack()
        {
            ...
            if (Envir.Random.Next(15) == 0)
                Target.ApplyPoison(new Poison { PType = PoisonType.Paralysis, Duration = 10, TickSpeed = 1000 }, this);

            Broadcast(new S.ObjectEffect { ObjectID = Target.ObjectID, Effect = SpellEffect.HellKeeper });
